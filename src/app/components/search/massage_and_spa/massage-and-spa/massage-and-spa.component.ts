...
@Component({
  selector: 'app-massage-and-spa',
  templateUrl: './massage-and-spa.component.html',
  styleUrls: ['./massage-and-spa.component.css']
})
export class MassageAndSpaComponent implements OnInit {
  persons: Array<any>;
  dataId: string;
  message = "test"
